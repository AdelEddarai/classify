...
export const CITIES:string[]=["","Marrackech","Rabat","Casablanca","Fez","Banff","Meknes"]
...
export const LOCATIONS:PassingDataType[]=[{name:"Marrackech",value:"Marrackech"},{name:"Rabat",value:"Rabat"},
                                   {name:"Casablanca",value:"Casablanca"},{name:"Fez",value:"Fez"},
                                   {name:"Meknes",value:"Meknes"},{name:"Tangier",value:"Tangier"}]
